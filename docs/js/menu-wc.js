...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ng-i18n documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/Culture.html" data-type="entity-link">Culture</a>
                            </li>
                            <li class="link">
                                <a href="classes/Translations.html" data-type="entity-link">Translations</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
